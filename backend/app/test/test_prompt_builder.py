...
def test_prompt_builder_empty_messages_with_current_input() -> None:
...
def test_prompt_builder_format_history() -> None:
    builder = PromptBuilder()
    history_messages = [
...
def test_prompt_builder_with_history_and_current_input() -> None:
    builder = PromptBuilder()
    history_messages = [
        {"role": "user", "content": "我叫张三", "timestamp": "2026-04-01T10:00:00"},
        {"role": "assistant", "content": "你好，张三", "timestamp": "2026-04-01T10:00:01"},
