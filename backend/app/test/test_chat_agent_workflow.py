...
assert runtime_session.planner_result["reason"] == "workflow planner direct workflow branch"
...
assert runtime_session.workflow_trace[1]["input_summary"] == "tool=time_tool,params={'content': '现在几点了？'}"
